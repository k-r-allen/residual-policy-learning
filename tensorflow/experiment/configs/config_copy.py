...
DEFAULT_ENV_PARAMS = {
    'GeneralizedResidualFetchReach-v0': {
        'n_cycles': 10,
    },
}
...
DEFAULT_PARAMS = {
    ...
    'network_class': 'models.actor_critic_last_zeros:ActorCritic',
    ...
    # exploration
    'random_eps': 0.3,  # percentage of time a random action is take
    # 'random_eps' : 1e-4,
    # 'noise_eps' : 1e-4,
    # 'random_eps': 1.0,  # percentage of time a random action is taken
