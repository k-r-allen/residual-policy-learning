...
class DDPG(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
                 ...
                 sample_transitions, gamma, controller_type='hook', reuse=False, freeze=False, **kwargs):
    ...
    def _controller_action(self, o, g):
        ...
        for i in range(0, o.shape[0]):
            ...
            if 'TwoFrame' in self.info['env_name']:
                obs['observation'] = obs['observation'][int(o.shape[1]/2):]
            if 'Hook' in self.info['env_name']:
                push_controls.append(get_hook_control(obs))
            elif 'MPCPush' in self.info['env_name']:
                mpc_obs = {}
                mpc_obs['observation'] = obs['observation'][:25]
